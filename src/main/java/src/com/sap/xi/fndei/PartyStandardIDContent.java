...
/** PartyStandardIDContent bean class */
@SuppressWarnings({"unchecked", "unused"})
public class PartyStandardIDContent implements org.apache.axis2.databinding.ADBBean {

  public static final javax.xml.namespace.QName MY_QNAME =
      new javax.xml.namespace.QName("http://sap.com/xi/FNDEI", "PartyStandardID.Content", "ns1");

  /** field for PartyStandardIDContent */
  protected org.apache.axis2.databinding.types.Token localPartyStandardIDContent;
    ...
    if (serializeType) {
      ...
      if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
        writeAttribute(
            ...
            "type",
            namespacePrefix + ":PartyStandardID.Content",
            xmlWriter);
      } else {
        writeAttribute(
            "xsi",
  ...
  public static class Factory {
    ...
    public static PartyStandardIDContent fromString(
        java.lang.String value, java.lang.String namespaceURI) {
      PartyStandardIDContent returnValue = new PartyStandardIDContent();
    ...
    public static PartyStandardIDContent fromString(
      ...
      if (content.indexOf(":") > -1) {
        ...
        return PartyStandardIDContent.Factory.fromString(content, namespaceUri);
      } else {
        return PartyStandardIDContent.Factory.fromString(content, "");
      }
    }
     ...
     */
    public static PartyStandardIDContent parse(javax.xml.stream.XMLStreamReader reader)
        throws java.lang.Exception {
      PartyStandardIDContent object = new PartyStandardIDContent();
