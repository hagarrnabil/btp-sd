...
/** PartyInternalIDContent bean class */
@SuppressWarnings({"unchecked", "unused"})
public class PartyInternalIDContent implements org.apache.axis2.databinding.ADBBean {

  public static final javax.xml.namespace.QName MY_QNAME =
      new javax.xml.namespace.QName("http://sap.com/xi/FNDEI", "PartyInternalID.Content", "ns1");

  /** field for PartyInternalIDContent */
  protected org.apache.axis2.databinding.types.Token localPartyInternalIDContent;
    ...
    if (serializeType) {
      ...
      if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
        writeAttribute(
            ...
            "type",
            namespacePrefix + ":PartyInternalID.Content",
            xmlWriter);
      } else {
        writeAttribute(
            "xsi",
  ...
  public static class Factory {
    ...
    public static PartyInternalIDContent fromString(
        java.lang.String value, java.lang.String namespaceURI) {
      PartyInternalIDContent returnValue = new PartyInternalIDContent();
    ...
    public static PartyInternalIDContent fromString(
      ...
      if (content.indexOf(":") > -1) {
        ...
        return PartyInternalIDContent.Factory.fromString(content, namespaceUri);
      } else {
        return PartyInternalIDContent.Factory.fromString(content, "");
      }
    }
     ...
     */
    public static PartyInternalIDContent parse(javax.xml.stream.XMLStreamReader reader)
        throws java.lang.Exception {
      PartyInternalIDContent object = new PartyInternalIDContent();
