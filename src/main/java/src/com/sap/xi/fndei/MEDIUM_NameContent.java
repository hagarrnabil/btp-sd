...
public class MEDIUM_NameContent implements org.apache.axis2.databinding.ADBBean {
  ...
  public static final javax.xml.namespace.QName MY_QNAME =
      new javax.xml.namespace.QName("http://sap.com/xi/FNDEI", "MEDIUM_Name.Content", "ns1");
    ...
    if (serializeType) {
      ...
      if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
        writeAttribute(
            ...
            "type",
            namespacePrefix + ":MEDIUM_Name.Content",
            xmlWriter);
      } else {
        writeAttribute(
            "xsi",
  ...
  public static class Factory {
    ...
    public static MEDIUM_NameContent fromString(
      ...
      if (content.indexOf(":") > -1) {
        ...
        return MEDIUM_NameContent.Factory.fromString(content, namespaceUri);
      } else {
     ...
     */
    public static MEDIUM_NameContent parse(javax.xml.stream.XMLStreamReader reader)
