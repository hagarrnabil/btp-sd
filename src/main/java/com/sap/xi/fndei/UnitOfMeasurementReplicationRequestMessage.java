/**
 * UnitOfMeasurementReplicationRequestMessage.java
 *
...
/** UnitOfMeasurementReplicationRequestMessage bean class */
@SuppressWarnings({"unchecked", "unused"})
public class UnitOfMeasurementReplicationRequestMessage
    implements org.apache.axis2.databinding.ADBBean {
  /* This type was generated from the piece of schema that had
  name = UnitOfMeasurementReplicationRequestMessage
  ...
  */
  ...
  public void addUnitOfMeasurement(UnitOfMeasurement param) {
    ...
    localUnitOfMeasurementTracker = true;
  ...
  public void serialize(
    ...
    if (serializeType) {
      ...
      if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
        writeAttribute(
            ...
            "type",
            namespacePrefix + ":UnitOfMeasurementReplicationRequestMessage",
            xmlWriter);
      } else {
        writeAttribute(
            "xsi",
    ...
    if (localListCompleteTransmissionIndicator == null) {
      throw new org.apache.axis2.databinding.ADBException(
          "ListCompleteTransmissionIndicator cannot be null!!");
    }
    localListCompleteTransmissionIndicator.serialize(
        new javax.xml.namespace.QName("", "ListCompleteTransmissionIndicator"), xmlWriter);

    if (localTransmissionStartDateTime == null) {
      throw new org.apache.axis2.databinding.ADBException(
          "TransmissionStartDateTime cannot be null!!");
    }
    localTransmissionStartDateTime.serialize(
        new javax.xml.namespace.QName("", "TransmissionStartDateTime"), xmlWriter);
    if (localUnitOfMeasurementTracker) {
      if (localUnitOfMeasurement != null) {
        for (int i = 0; i < localUnitOfMeasurement.length; i++) {
          if (localUnitOfMeasurement[i] != null) {
            localUnitOfMeasurement[i].serialize(
                new javax.xml.namespace.QName("", "UnitOfMeasurement"), xmlWriter);
          } else {
  ...
  public static class Factory {
     ...
     */
    public static UnitOfMeasurementReplicationRequestMessage parse(
        javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
      UnitOfMeasurementReplicationRequestMessage object =
      ...
      try {
        ...
        if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
          ...
          if (fullTypeName != null) {
            ...
            if (!"UnitOfMeasurementReplicationRequestMessage".equals(type)) {
        ...
        if (reader.isStartElement()
            && new javax.xml.namespace.QName("", "ListCompleteTransmissionIndicator")
        ...
        if (reader.isStartElement()
            && new javax.xml.namespace.QName("", "TransmissionStartDateTime")
                .equals(reader.getName())) {
        ...
        if (reader.isStartElement()
            && new javax.xml.namespace.QName("", "UnitOfMeasurement").equals(reader.getName())) {
