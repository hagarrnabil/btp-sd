...
/** BusinessScopeIDContent bean class */
@SuppressWarnings({"unchecked", "unused"})
public class BusinessScopeIDContent implements org.apache.axis2.databinding.ADBBean {

  public static final javax.xml.namespace.QName MY_QNAME =
      new javax.xml.namespace.QName("http://sap.com/xi/FNDEI", "BusinessScopeID.Content", "ns1");

  /** field for BusinessScopeIDContent */
  protected org.apache.axis2.databinding.types.Token localBusinessScopeIDContent;
    ...
    if (serializeType) {
      ...
      if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
        writeAttribute(
            ...
            "type",
            namespacePrefix + ":BusinessScopeID.Content",
            xmlWriter);
      } else {
        writeAttribute(
            "xsi",
  ...
  public static class Factory {
    ...
    public static BusinessScopeIDContent fromString(
        java.lang.String value, java.lang.String namespaceURI) {
      BusinessScopeIDContent returnValue = new BusinessScopeIDContent();
    ...
    public static BusinessScopeIDContent fromString(
      ...
      if (content.indexOf(":") > -1) {
        ...
        return BusinessScopeIDContent.Factory.fromString(content, namespaceUri);
      } else {
        return BusinessScopeIDContent.Factory.fromString(content, "");
      }
    }
     ...
     */
    public static BusinessScopeIDContent parse(javax.xml.stream.XMLStreamReader reader)
        throws java.lang.Exception {
      BusinessScopeIDContent object = new BusinessScopeIDContent();
